...
function App() {
  ...
  return (
    <>
      <header className='p-5 flex iems-center justify-between'>
        <div className='lg:flex lg:items-start lg:justify-start'>
          ...
          <nav className='navbar'>
            <div>
              ...
              className='flex iems-center justify-start'>Features
                {openFeatures ? <img src={chevronUp} alt='' className='ml-2' /> : 
                <img src={chevronDown} alt='' className='ml-2'/>}
              </button>
              {openFeatures && (
                <ul className='mt-2 ml-3 lg:ml-0 md:p-3 lg:shadow'>
            ...
            <div>
              <button onClick={() => setOpenCompany(!openCompany)} className='flex items-center justify-start'>Company 
                {openCompany ? <img src={chevronUp} alt='' className='ml-2' /> : <img src={chevronDown} alt='' className='ml-2'/>}
              </button>
              {openCompany && <ul className='mt-2 ml-3 lg:ml-0 md:p-3 lg:shadow'>
